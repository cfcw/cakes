...
class HistoriesControllerTest < ActionController::TestCase
  ...
  test "should create history" do
    assert_difference('History.count') do
      post :create, history: { action: @history.action, ip_address: @history.ip_address }
    end
  ...
  test "should update history" do
    put :update, id: @history, history: { action: @history.action, ip_address: @history.ip_address }
    assert_redirected_to history_path(assigns(:history))
  end
